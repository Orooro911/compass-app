/**
 * TEMPORARY archive: former "Compass Modules" In Practice sub-tab for the Compass Framework lightbox.
 * Restore by merging back into compassFrameworkContent if needed.
 */

import type { InfoBlock } from "../dashboard/infoContent";

export const COMPASS_FRAMEWORK_IN_PRACTICE_MODULES_ARCHIVED: InfoBlock[] = [
